...
| OPEN-Q-07 | ¿Se enmienda el Concept Note agregando una fila `D-*` por cada decisión de Spec §3.4? | Lucas Manoukian | Ninguna — rama propia | Heredada de Spec `OPEN-Q-07`, levantada por la auto-crítica. Es una rama de documentación aparte, anterior a la rebanada 3 |
