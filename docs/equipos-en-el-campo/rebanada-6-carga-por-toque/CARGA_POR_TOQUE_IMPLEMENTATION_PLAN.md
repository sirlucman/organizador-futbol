...
|---|---|---|---|
| TD-01 | El toque ocurre sobre `<span class="camiseta-nombre">`, no sobre `<div class="camiseta">` completo | `FR-030`, `FR-030b` | Es lo que permite que una dupla (dos nombres, una sola camiseta compartida, [`index.html:4270-4273`](../../../index.html#L4270-L4273)) tenga dos destinos de toque independientes sin agregar ningún control nuevo — cada nombre ya es un elemento propio |
