...
- **FR-009**: El sistema MUST mostrar una imagen de fondo personalizada en la pantalla de login (imagen provista por el usuario, ver `docs/005-login-basico/assets/fondo-login.jpeg`).
