...
**Input**: Design documents from `docs/005-login-basico/`
...
- [X] T006 Crear el markup y CSS de la pantalla de login en `index.html`: campos de usuario y contraseña, botón de confirmar, contenedor de mensaje de error, e imagen de fondo tomada de `docs/005-login-basico/assets/fondo-login.jpeg` (FR-001, FR-009)
