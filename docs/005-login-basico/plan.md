...
**Input**: Feature specification from `docs/005-login-basico/spec.md`
...
- **I. Specs como fuente de verdad**: OK — esta feature parte de `spec.md` en `docs/005-login-basico/`, no se toca código sin spec previo.
