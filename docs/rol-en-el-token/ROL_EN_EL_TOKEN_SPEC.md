...
- **Plan must resolve:** `OPEN-Q-01`, `OPEN-Q-02`, `OPEN-Q-03`. (`OPEN-Q-04` quedó resuelta por medición el 2026-09-09 — ver §16.) Al reescribir las reglas, `TC-041` obliga a incluir `data/ordenJugadoresMigrado`, que el contrato committeado no documenta.
