...
- **AC-11** — NFR-001b verificado midiendo el **arranque completo** con una sesión de más de una hora, y comprobando que la mediana de tres corridas es ≤ 400 ms y menor que la línea de base de 487 ms. **Corregido el 2026-09-09** por la misma causa raíz que NFR-001b: medir sólo el hueco, que `TD-02` vuelve 0 ms por construcción, no verificaría nada. Reformulado el 2026-09-10 sin el loader.
