...
**Input**: Feature specification en `docs/004-estadisticas-vista-jugadores/spec.md`. Los totales de goles y asistencias ya se acumulan por jugador desde FR-014 de `002-gestion-jugadores`, pero nunca se muestran; los partidos jugados no se acumulan en absoluto todavía.
...
```text
docs/004-estadisticas-vista-jugadores/
