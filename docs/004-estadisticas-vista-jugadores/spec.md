...
3. **Given** la app sin sesión de administrador iniciada, **When** alguien intenta editar el resultado de un partido finalizado, **Then** el sistema lo rechaza de la misma forma en que hoy rechaza cualquier otra escritura sin sesión válida (ver `docs/005-login-basico/spec.md`).
