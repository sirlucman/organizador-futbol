...
**Input**: Feature specification from `docs/006-copiar-formacion/spec.md`
...
- **I. Specs como fuente de verdad**: OK — esta feature parte de `spec.md` en `docs/006-copiar-formacion/`, clarificado previamente vía `/speckit-clarify`.
